...
\input{chapters/subchapters/technologies/react/create-project}

% ==> Project folder structure <== %
\input{chapters/subchapters/technologies/react/dir-structure}

% ==> How to run React project <== %
\input{chapters/subchapters/technologies/react/run-project}