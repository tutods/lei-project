...
Em \hyperrefUnder{nodeArch}{anexo} é possível ecnontrar a imagem que representa a arquitetura do \textbf{NodeJS} em comparação com a arquitetura tradicional\footnote{\textbf{Imagem retirada de} \cite{caseByCaseNode}}.
...
Além disso, é ainda possível encontrar em \underline{\hyperref[nodeAttachments]{anexo}} como realizar a instalação do \textbf{NodeJS} nos diversos sistemas opertivos.