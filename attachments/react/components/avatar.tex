...
\begin{minipage}{0.55\textwidth}
	\figureFrame{1}{avatar-athlete-profile.png}{Componente \textbf{Avatar} na página de perfil do atleta}
\end{minipage}
\begin{minipage}{0.35\textwidth}
	\figureFrame{1}{avatar-athletes-mosaic.png}{Componente \textbf{Avatar} na vista em mosaico na lista de atletas}
\end{minipage}

\figureFrame{1}{avatar-athletes-list.png}{Componente \textbf{Avatar} na lista de atletas}
