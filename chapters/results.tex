...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{backoffice-components.png}{\textbf{\textit{Backoffice}:} pasta \texttt{components}}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{backoffice-controllers.png}{\textbf{\textit{Backoffice}:} pasta \texttt{controllers}}
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{backoffice-mosaic-athletes.png}{\textbf{\textit{Backoffice}:} vista em mosaico dos atletas}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{backoffice-list-athletes.png}{\textbf{\textit{Backoffice}:} vista em lista dos atletas}
\end{minipage}
...
\figureFrame{.75}{backoffice-athlete-profile.png}{\textbf{\textit{Backoffice}:} página de perfil do atleta}
...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{frontoffice-components.png}{\textbf{\textit{Frontoffice}:} pasta \texttt{components}}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{frontoffice-controllers.png}{\textbf{\textit{Frontoffice}:} pasta \texttt{controllers}}
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{frontoffice-register.png}{\textbf{\textit{Frontoffice}:} criação de conta do atleta}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{frontoffice-complete-register.png}{\textbf{\textit{Frontoffice}:} finalização da criação de conta}
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{wizard-athlete.png}{\textbf{\textit{Frontoffice}:} passo inicial do \textit{wizard}}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{wizard-athlete-personal-info.png}{\textbf{\textit{Frontoffice}:} informações pessoais e de pagamento do \textit{wizard}}
\end{minipage}
...
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{wizard-athlete-resume.png}{\textbf{\textit{Frontoffice}:} resumo do \textit{wizard}}
\end{minipage}
\begin{minipage}[t]{0.45\textwidth}
	\figureFrame{1}{wizard-popup.png}{\textbf{\textit{Frontoffice}:} \textit{popup} apresentado no final do \textit{wizard}}
\end{minipage}