...
Em \underline{\hyperref[reactAttachments]{anexo {\foonotesize(página 56 a 70)}}} é possível encontrar todas as instruções relativas à criação de um projeto, bem como estrutura de pastas e execução de um projeto \textbf{React}.
