...
Nos projetos apresentados os principais conhecimentos aplicados foram relacionados com a biblioteca \textbf{React}, mais precisamente na utilização de contextos, o uso de \textit{Styled Components} para realizar todo o \textit{layout} da aplicação (em vez de ficheiros \textbf{CSS} ou \textbf{Sass}) e o uso de dois temas, no caso \textit{dark} e \textit{light mode}. Foi também ainda possível conhecer um pouco do funcionamento de \textbf{GraphQL} com \textbf{TypeGraphQL}.

Assim, e através de todos os projetos realizados, é possível afirmar que foram uma mais valia para conhecer com mais detalhe algumas das tecnologias referidas.