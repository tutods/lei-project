...
\figureFrame{.75}{jest-code-coverage.png}{\textbf{Jest} \textemdash~cobertura de código}
...
\figureFrame{.75}{cypress-test.png}{\textbf{Cypress} \textemdash~resultado do teste apresentado}
